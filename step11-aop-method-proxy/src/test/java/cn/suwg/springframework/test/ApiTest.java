...
import cn.suwg.springframework.aop.framework.JdkDynamicAopProxy;
...
public class ApiTest {
    ...
    public void testAop() throws NoSuchMethodException {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut("execution(* cn.suwg.springframework.test.bean.UserService.*(..))");
